        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-zinc-400 text-lg mb-12 max-w-md">
              ...
              If you have a technical challenge that needs a senior engineer's
              touch, let's talk.
            </p>
...
function ContactLink({
  ...
  return (
    <a
      ...
      className="flex items-center gap-4 p-4 rounded-lg hover:bg-zinc-900/50 transition-colors group"
    >
      <div className="p-3 bg-zinc-900 rounded-full text-zinc-400 group-hover:text-white group-hover:bg-blue-600 transition-all">
        {icon}
      </div>
      <div>
        <div className="text-zinc-200 font-medium group-hover:text-white">
          {label}
        </div>
