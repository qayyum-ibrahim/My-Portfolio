      ...
      <section className="relative min-h-[90vh] flex items-center pt-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              I build scalable websites and application systems that power real
              businesses.
            </motion.h1>
            ...
            >
              Full-Stack Engineer specializing in User Interface and Experience, APIs, distributed systems,
              caching strategies,transaction-safe platforms
            </motion.p>
            ...
            >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 px-8 text-base border-zinc-700 hover:bg-zinc-900 hover:text-white"
              >
            ...
            >
              {[
                ...
                <span
                  key={tech}
                  className="font-mono text-sm uppercase tracking-wider hover:text-zinc-300 transition-colors cursor-default"
                >
                  {tech}
                </span>
              ))}
...
function FeatureCard({
  ...
  return (
    <div className="p-8 rounded-xl border border-zinc-900 bg-zinc-900/20 hover:border-zinc-800 hover:bg-zinc-900/40 transition-all duration-300 group">
      ...
      <h3 className="text-xl font-display font-semibold mb-3 text-zinc-100">
        {title}
      </h3>
