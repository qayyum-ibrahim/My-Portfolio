      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <img src="qayyum.png" className="object-cover object-[50%_45%] top-10 h-96 w-full mb-12" />
            <div>
              ...
              <div className="prose prose-invert prose-lg text-zinc-400 mb-16">
                <p>
                  I am a Backend-Focused Full-Stack Engineer with over 6 years
                  of experience building production-grade software. My career
                  hasn't been about just closing tickets; it's been about owning
                  systems end-to-end.
                </p>
                <p>
                  I specialize in the "hard parts" of web development: database
                  schema design, handling race conditions, managing distributed
                  state, and ensuring that APIs don't just work on my machine,
                  but scale in production.
                </p>
                <p>
                  While my core strength lies in Node.js and backend
                  architecture, I treat the frontend with the same level of
                  rigor. I believe a Full-Stack engineer should be able to
                  center a div as confidently as they optimize a database query.
                </p>
              </div>
...
function SkillSection({ title, skills }: { title: string; skills: string[] }) {
  return (
    <div>
      <h3 className="text-lg font-display font-bold mb-4 border-b border-zinc-800 pb-2">
        {title}
      </h3>
      <div className="flex flex-wrap gap-2">
        {skills.map((skill) => (
          <span
            key={skill}
            className="px-3 py-1.5 bg-zinc-900 text-zinc-400 text-sm border border-zinc-800 rounded hover:border-zinc-600 transition-colors cursor-default"
          >
            {skill}
          </span>
        ))}
